...
type UserBookCategorySubscriptionRepository interface {
	FindSubscription(ctx context.Context, userID uint, bookCategory string) (*model.UserBookCategory, error)
	GetSubscriptionUserIDs(ctx context.Context, bookCategory string) ([]uint, error)
	...
	Delete(ctx context.Context, userID uint, bookCategory string) error
}

type bookCategorySubscriptionRepository struct {
	name    string
...
func (r *bookCategorySubscriptionRepository) FindSubscription(ctx context.Context, userID uint, bookCategory string) (*model.UserBookCategory, error) {
	...
	if err := r.db.WithContext(ctx).
		...
		Where("book_category ILIKE ?", bookCategory).
...
func (r *bookCategorySubscriptionRepository) GetSubscriptionUserIDs(ctx context.Context, bookCategory string) ([]uint, error) {
	ctx, cancel := context.WithTimeout(ctx, r.timeout)
	defer cancel()
...
func (r *bookCategorySubscriptionRepository) GetUserSubscribedBookCategories(ctx context.Context, userID uint) ([]string, error) {
	ctx, cancel := context.WithTimeout(ctx, r.timeout)
	defer cancel()
...
func (r *bookCategorySubscriptionRepository) Create(ctx context.Context, userBookCategory *model.UserBookCategory) error {
	ctx, cancel := context.WithTimeout(ctx, r.timeout)
	defer cancel()
...
func (r *bookCategorySubscriptionRepository) Delete(ctx context.Context, userID uint, bookCategory string) error {
	ctx, cancel := context.WithTimeout(ctx, r.timeout)
	defer cancel()
